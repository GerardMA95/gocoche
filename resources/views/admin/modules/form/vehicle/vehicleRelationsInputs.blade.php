...
<div class="card">
    ...
    <div class="card-body">
        <div class="form-group light-blue-text">
            <label for="patentList">Marca</label>
            <select id="patentList" class="form-control" name="{{ class_basename(\App\Patent::class) }}" required>
        ...
        <div class="form-group light-blue-text">
            <label for="patternList">Modelo</label>
            <select id="patternList" class="form-control" name="{{ class_basename(\App\Pattern::class) }}" required>
