...
class GearshiftController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return view('admin.entity.gearshift.index', ['itemArray' => $gearshiftArray, 'routeName' => self::self_route, 'alertArray' => $alertArray]);
    }
    ...
    public function update(Request $request, Gearshift $gearshift)
    {
        ...
        return view('admin.entity.gearshift.edit', ['item' => $gearshift, 'routeName' => self::self_route, 'formMethod' => self::put_method, 'alertArray' => $alertArray, 'routeAction' => 'update']);
    }
